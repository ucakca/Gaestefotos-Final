...
export const STEP_TYPES: StepTypeDefinition[] = [
  ...
  // ── AI (Phase 2) ──
  {
    ...
    defaultConfig: {
      ...
      categories: 'people,landscape,food,decoration,party,ceremony,group',
      autoTag: true,
    ...
    configFields: [
      { key: 'categories', label: 'Kategorien (kommagetrennt)', type: 'textarea', placeholder: 'people,landscape,food,decoration,party,ceremony,group' },
      ...
      { key: 'detectFaces', label: 'Gesichter erkennen', type: 'toggle', defaultValue: true },
      { key: 'detectObjects', label: 'Objekte erkennen', type: 'toggle', defaultValue: true },
      { key: 'generateCaption', label: 'Bildunterschrift generieren', type: 'toggle', defaultValue: false },
    ],
    outputs: [
      { id: 'default', label: 'Kategorisiert', type: 'default' },
      { id: 'low_confidence', label: 'Unsicher', type: 'conditional' },
    ],
  },
  ...
  // ── EMAIL (Phase 2) ──
  {
    ...
    defaultConfig: {
      template: 'invitation',
      subject: 'Du bist eingeladen: {eventName}',
      includeQR: true,
      includeCalendar: true,
      recipientSource: 'guest_list',
    },
    configFields: [
      { key: 'subject', label: 'Betreff', type: 'text', placeholder: 'Du bist eingeladen: {eventName}' },
      { key: 'template', label: 'Template', type: 'select', options: [
        { value: 'invitation', label: 'Standard-Einladung' },
        { value: 'branded', label: 'Gebrandetes Template' },
        { value: 'minimal', label: 'Minimal' },
      ]},
      { key: 'includeQR', label: 'QR-Code beilegen', type: 'toggle', defaultValue: true },
      { key: 'includeCalendar', label: 'Kalender-Datei (.ics)', type: 'toggle', defaultValue: true },
      { key: 'recipientSource', label: 'Empfänger', type: 'select', options: [
        { value: 'guest_list', label: 'Gästeliste' },
        { value: 'co_hosts', label: 'Co-Hosts' },
        { value: 'all', label: 'Alle (Gäste + Co-Hosts)' },
      ]},
    ],
    outputs: [{ id: 'default', label: 'Gesendet', type: 'default' }],
  },
  {
    ...
    defaultConfig: {
      template: 'reminder',
      subject: 'Erinnerung: {eventName} startet bald!',
      timing: 'before_event',
      hoursOffset: 24,
      recipientSource: 'guest_list',
    },
    configFields: [
      { key: 'subject', label: 'Betreff', type: 'text', placeholder: 'Erinnerung: {eventName}' },
      { key: 'template', label: 'Template', type: 'select', options: [
        { value: 'reminder', label: 'Standard-Erinnerung' },
        { value: 'branded', label: 'Gebrandetes Template' },
        { value: 'urgent', label: 'Dringend' },
      ]},
      { key: 'timing', label: 'Zeitpunkt', type: 'select', options: [
        { value: 'before_event', label: 'Vor Event-Beginn' },
        { value: 'after_trigger', label: 'Nach Trigger' },
      ]},
      { key: 'hoursOffset', label: 'Stunden vorher/nachher', type: 'number', min: 1, max: 168, defaultValue: 24 },
      { key: 'recipientSource', label: 'Empfänger', type: 'select', options: [
        { value: 'guest_list', label: 'Gästeliste' },
        { value: 'rsvp_yes', label: 'Nur Zusagen' },
        { value: 'rsvp_pending', label: 'Noch offen' },
      ]},
    ],
    outputs: [{ id: 'default', label: 'Gesendet', type: 'default' }],
  },
  {
    ...
    defaultConfig: {
      template: 'thank_you',
      subject: 'Danke für deine Teilnahme an {eventName}!',
    ...
    configFields: [
      { key: 'subject', label: 'Betreff', type: 'text', placeholder: 'Danke für {eventName}!' },
      { key: 'template', label: 'Template', type: 'select', options: [
        { value: 'thank_you', label: 'Standard-Danke' },
        { value: 'branded', label: 'Gebrandetes Template' },
        { value: 'photo_recap', label: 'Mit Foto-Rückblick' },
      ]},
      { key: 'includeGalleryLink', label: 'Galerie-Link', type: 'toggle', defaultValue: true },
      { key: 'includePhotoCount', label: 'Foto-Statistik', type: 'toggle', defaultValue: true },
      { key: 'includeHighlights', label: 'Highlight-Fotos', type: 'toggle', defaultValue: true },
      { key: 'recipientSource', label: 'Empfänger', type: 'select', options: [
        { value: 'attendees', label: 'Teilnehmer (mit Fotos)' },
        { value: 'guest_list', label: 'Gästeliste' },
  ...
  {
    type: 'EMAIL_STORAGE_EXPIRY',
    label: 'Speicher-Ablauf E-Mail',
    category: 'cloud',
    icon: 'AlertCircle',
    color: 'text-blue-700',
    bgColor: 'bg-blue-50',
    borderColor: 'border-blue-300',
    defaultConfig: {
      template: 'storage_expiry',
      subject: 'Deine Fotos von {eventName} werden bald gelöscht',
      daysBeforeExpiry: 7,
      includeDownloadLink: true,
      includeUpgradeLink: true,
    },
    configFields: [
      { key: 'subject', label: 'Betreff', type: 'text', placeholder: 'Fotos werden bald gelöscht' },
      { key: 'template', label: 'Template', type: 'select', options: [
        { value: 'storage_expiry', label: 'Standard-Warnung' },
        { value: 'urgent', label: 'Dringend (roter Header)' },
      ]},
      { key: 'daysBeforeExpiry', label: 'Tage vor Ablauf', type: 'number', min: 1, max: 30, defaultValue: 7 },
      { key: 'includeDownloadLink', label: 'Download-Link', type: 'toggle', defaultValue: true },
      { key: 'includeUpgradeLink', label: 'Upgrade-Link', type: 'toggle', defaultValue: true },
    ],
    outputs: [{ id: 'default', label: 'Gesendet', type: 'default' }],
  },
