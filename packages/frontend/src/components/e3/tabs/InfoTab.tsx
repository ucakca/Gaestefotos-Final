  ...
  return (
    <div className="bg-card border border-border rounded-2xl p-5 shadow-sm">
      ...
      <div className="bg-muted/50 rounded-xl p-3 mb-3">
        <p className="text-xs text-muted-foreground mb-1">{t('networkName')}</p>
                ...
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      {new Date(event.dateTime).toLocaleDateString(dateLocaleMap[locale] || 'de-DE', {
                        day: 'numeric',
                        month: 'long',
                        year: 'numeric',
                      })}
                    ...
                    {schedule.map((item: { time: string; title: string; description?: string }, index: number) => (
                      <div key={index} className="flex gap-4 relative">
                        ...
                        <div className="flex-1 pb-2">
                          ...
                          <p className="text-muted-foreground text-sm">{item.time}{t('oclock') ? ` ${t('oclock')}` : ''}</p>
                          {item.description && (
          ...
          >
            ...
            <div className="bg-card border border-border rounded-2xl p-5 shadow-sm">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="font-bold text-foreground">{t('appName')}</h3>
              ...
              <div className="space-y-2">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-foreground font-medium">{t('whatsappSupport')}</span>
                  </div>
                  <ChevronRight className="w-5 h-5 text-muted-foreground/70" />
                </a>
                <a
                ...
                >
                  <div className="flex items-center gap-3">
                    <Mail className="w-5 h-5 text-muted-foreground" />
                    <span className="text-foreground">{t('emailSupport')}</span>
                  </div>
                  <ChevronRight className="w-5 h-5 text-muted-foreground/70" />
                </a>
              </div>
