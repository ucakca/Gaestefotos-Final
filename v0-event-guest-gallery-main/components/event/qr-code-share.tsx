    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4">
      <div className="relative w-full max-w-sm rounded-2xl bg-card p-6 shadow-2xl animate-in fade-in-0 zoom-in-95">
        ...
        <div className="flex justify-center mb-6">
          ...
          >
            {/* Simple QR Code representation - replace with actual QR library */}
...
// Button to open QR Code Share modal
interface QRCodeButtonProps {
  onClick: () => void;
  className?: string;
}

export function QRCodeButton({ onClick, className }: QRCodeButtonProps) {
  return (
    <Button
      variant="outline"
      size="icon"
