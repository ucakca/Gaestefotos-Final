    ...
    <div className="fixed bottom-4 left-4 right-4 md:left-auto md:right-4 md:w-80 z-50 animate-slide-up">
      <div className="bg-brand-primary text-white rounded-xl shadow-lg p-4">
        <div className="flex items-start gap-3">
          <div className="w-8 h-8 rounded-full bg-card/20 flex items-center justify-center flex-shrink-0">
          ...
          <div className="flex-1 min-w-0">
            ...
            <button
              onClick={onUpdate}
              className="mt-2 px-3 py-1.5 bg-card text-brand-primary rounded-lg text-sm font-medium hover:bg-card/90 transition-colors"
            >
              Jetzt aktualisieren
            </button>
          </div>
