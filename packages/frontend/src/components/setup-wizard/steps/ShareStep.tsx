      ...
      >
        ...
        <div className="flex gap-2">
          ...
          <Button
            onClick={handleCopy}
            variant="ghost"
            className={`px-4 ${copied ? 'text-success' : 'text-muted-foreground'}`}
          >
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <button
            ...
            className="flex items-center gap-3 p-4 bg-success/10 hover:bg-success/15 rounded-xl transition-colors"
          >
          ...
          >
            <div className="w-10 h-10 flex-shrink-0 rounded-full bg-foreground/70 flex items-center justify-center">
          ...
          {showMoreOptions && (
            ...
            >
              <div className="grid grid-cols-2 gap-3">
                ...
                <button
                  onClick={handleSMS}
                  className="flex items-center gap-3 p-3 bg-success/10 hover:bg-success/15 rounded-xl transition-colors"
                >
                  ...
                  <span className="text-sm font-medium text-success">SMS</span>
                </button>
