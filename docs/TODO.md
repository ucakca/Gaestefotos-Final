...
| S26-647 | **Top-Commented** | ✅ erledigt (21.02.2026) | GET /events/:id/photos/top-commented (top20 photos by comment count) |
...
| S26-663 | **Guest-Upload-Timeline** | ✅ erledigt (21.02.2026) | GET /events/:id/photos/guest-upload-timeline (uploads per day for top5 guests) |
...
| S26-675 | **Category-Approval-Rate** | ✅ erledigt (21.02.2026) | GET /events/:id/photos/category-approval-rate (approval rate per category sorted desc) |
...
| S26-683 | **Top-Viewed-Today** | ✅ erledigt (21.02.2026) | GET /events/:id/photos/top-viewed-today (top10 photos by views updated today) |
...
| S26-691 | **Top-Commented-Today** | ✅ erledigt (21.02.2026) | GET /events/:id/photos/top-commented-today (top10 photos by comments added today) |
...
| S26-703 | **Top-Viewed-This-Week** | ✅ erledigt (21.02.2026) | GET /events/:id/photos/top-viewed-this-week (top20 most viewed photos in last 7 days) |
| S26-704 | **Guest-Upload-Rank** | ✅ erledigt (21.02.2026) | GET /events/:id/photos/guest-upload-rank (top50 guests ranked by upload count + avgQuality) |
| S26-705 | **Photo-Age-Distribution** | ✅ erledigt (21.02.2026) | GET /events/:id/photos/photo-age-distribution (photos grouped by age <1/1-7/7-30/30-90/90+) |
| S26-706 | **Sprint S26 Meilenstein** | ✅ erledigt (21.02.2026) | 706 Features in Sprint S26 implementiert + deployed |
| S26-707 | **Top-Voted-This-Week** | ✅ erledigt (21.02.2026) | GET /events/:id/photos/top-voted-this-week (top20 photos by votes cast in last 7 days) |
| S26-708 | **Category-View-Total** | ✅ erledigt (21.02.2026) | GET /events/:id/photos/category-view-total (total views per category sorted desc) |
| S26-709 | **Uploader-Quality-Avg** | ✅ erledigt (21.02.2026) | GET /events/:id/photos/uploader-quality-avg (top20 uploaders by avg quality score min 2 photos) |
| S26-710 | **Sprint S26 Meilenstein** | ✅ erledigt (21.02.2026) | 710 Features in Sprint S26 implementiert + deployed |
| S26-711 | **Pending-Oldest** | ✅ erledigt (21.02.2026) | GET /events/:id/photos/pending-oldest (top20 PENDING photos waiting longest for review) |
...
| S26-731 | **Top-Voted-Approved** | ✅ erledigt (21.02.2026) | GET /events/:id/photos/top-voted-approved (top20 approved photos by vote count + avgRating) |
| S26-732 | **Guest-Comment-Rank** | ✅ erledigt (21.02.2026) | GET /events/:id/photos/guest-comment-rank (top20 guests by comment count) |
| S26-733 | **Count-By-Status** | ✅ erledigt (21.02.2026) | GET /events/:id/photos/count-by-status (photo count + avgQuality + totalViews per status) |
| S26-734 | **Sprint S26 Meilenstein** | ✅ erledigt (21.02.2026) | 734 Features in Sprint S26 implementiert + deployed |
| S26-735 | **Top-Commented-Approved** | ✅ erledigt (21.02.2026) | GET /events/:id/photos/top-commented-approved (top20 approved photos by comment count) |
...
| S26-788 | **Admin Events-Übersicht Frontend** | ✅ erledigt (21.02.2026) | /admin/events: Suche, Aktiv-Toggle, Fotos/Gäste-Zähler, Dashboard-Links, Pagination |
| S26-789 | **Admin-Hub Events-Link** | ✅ erledigt (21.02.2026) | Events-Übersicht in Event-Verwaltung Sektion des Admin-Hubs |
| S26-790 | **Sprint S26 Meilenstein** | ✅ erledigt (21.02.2026) | 790 Features in Sprint S26 implementiert + deployed |
