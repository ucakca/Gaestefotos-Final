...
export default function Step2TargetOverlay({
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-lg font-bold text-foreground mb-1">Zielbild & Overlay</h2>
            ...
            <div className="space-y-5 pt-2">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label className="text-sm font-medium text-foreground/80">Zielbild-Overlay</label>
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label className="text-sm font-medium text-foreground/80">Farbplatzierung</label>
                ...
                {scatterMode === 'manual' ? (
                  ...
                  <p className="text-xs text-muted-foreground/70 bg-muted/50 p-2 rounded-lg">
